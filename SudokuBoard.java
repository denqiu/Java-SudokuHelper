...
public class SudokuBoard extends JFrame { 
	 ...
	 */
	public static SudokuBlocks[] blocks = new SudokuBlocks[9];
	
	/**
	 * A 2D-Array of nine groups of nine Cells.
	 */
	public static SudokuCells[][] allCells = new SudokuCells[9][9];
	...
	public SudokuBoard() {
		...
		SudokuController playSudoku = new SudokuController();
		
		int xPosition;
		int yPosition;
		for (int i = 0; i < 9; i++) {
			blocks[i] = new SudokuBlocks(i);
			for (SudokuCells cells : blocks[i].getCellsInBlock()) {
				...
				cells.addMouseMotionListener(playSudoku);		
	...
	public void buildMenu() {	
        SudokuController gamePlay = new SudokuController();
	...
	public static void readPuzzle(File file) {
		...
		SudokuController.clearBoard();
		SudokuController.restartBoard();
        try {
